fun main() {
    ...
    fun part1(input: String): Int = input.signalStartIndex(4)

    fun part2(input: String): Int = input.signalStartIndex(14)
...
private fun String.signalStartIndex(markerLength: Int) =
